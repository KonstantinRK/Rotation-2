...
from tcav2mod.cav import CAV
from tcav2mod.cav import get_or_train_cav
from tcav2mod import run_params
from tcav2mod import utils
import numpy as np
import time
    ...
    def compute_tcav_score(mymodel,
        ...
        if run_parallel:
            ...
            for i in range(len(class_acts)):
                ...
                example = examples[i]
                count.append(TCAV.get_direction_dir_sign(
